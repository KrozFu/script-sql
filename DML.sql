-- SCRIPT PARA INSERTAR REGISTROS MODELO RELACIONAL DE REGISTRO ACADEMICO
-- ANTES DE EJECUTARLO DEBE HABER CREADO LAS TABLAS:  EJECUTE RELACIONALBD.SQL
-------------------------------------

-- Se ejecuta en un solo bloque, menos instrucciones de inserccion para el motor de base de datos
--INSERTAR REGISTROS
BEGIN
    ...
    INSERT INTO ESTUDIANTES VALUES (180, 'Norberto', 'Rodriguez', 'Ciencias Politicas', 5);
    ...
    INSERT INTO ESTUDIANTES VALUES (185, 'Camilo', 'Curry', 'Ingenieria Telematica', 6);
    INSERT INTO ESTUDIANTES VALUES (186, 'Jose', 'Allen', 'Nutricion', 3);
    INSERT INTO ESTUDIANTES VALUES (187, 'Ignacia', 'Velez', 'Ingenieria Informatica',3);
    INSERT INTO ESTUDIANTES VALUES (188, 'Rei', 'Monteverde', 'Ingenieria Telematica', 4);
    INSERT INTO ESTUDIANTES VALUES (189, 'Koy', 'Lusto', 'Ingenieria Telematica', 3);
    INSERT INTO ESTUDIANTES VALUES (190, 'Marino', 'Garrido', 'Ciencias Politicas', 12);
    INSERT INTO ESTUDIANTES VALUES (191, 'Alberto', 'Ospina', 'Ingenieria Informatica', 14);
    INSERT INTO ESTUDIANTES VALUES (192, 'Antonio', 'Escobar', 'Computacion', 4);
    INSERT INTO ESTUDIANTES VALUES (193, 'Rey', 'Piedrahita', 'Ingenieria Telematica', 10);
    INSERT INTO ESTUDIANTES VALUES (194, 'Karl', 'Kartor', 'Ingenieria Informatica', 9);
    INSERT INTO ESTUDIANTES VALUES (195, 'Lorenzo', 'Martinez','Ingenieria Telematica', 5);
    INSERT INTO ESTUDIANTES VALUES (196, 'Marcela', 'Sibundoy', 'Ingenieria Informatica', 11);
    INSERT INTO ESTUDIANTES VALUES (197, 'Fabricio', 'Del Sol', 'Ingenieria Informatica', 11);
    INSERT INTO ESTUDIANTES VALUES (198, 'Linda', 'Konsh', 'Ingenieria Telematica', 10);
    INSERT INTO ESTUDIANTES VALUES (199, 'Ruben', 'Rodriguez', 'Ingenieria Informatica', 7);
    INSERT INTO ESTUDIANTES VALUES (200, 'Sonia', 'Naranjo', 'Ingenieria Informatica', 6);
    INSERT INTO ESTUDIANTES VALUES (201, 'Paolo', 'Nunes', 'Ingenieria Telematica', 3);
    INSERT INTO ESTUDIANTES VALUES (202, 'Juana', 'Del Potro', 'Ingenieria Telematica', 3);
    INSERT INTO ESTUDIANTES VALUES (203, 'Camilo', 'Perez', 'Ingenieria Informatica', 8);
    INSERT INTO ESTUDIANTES VALUES (204, 'Pedro', 'Pascully', 'Ingenieria Informatica', 4);
    INSERT INTO ESTUDIANTES VALUES (205, 'Jorge', 'Martin', 'Ingenieria Informatica', 2);
    ...
    INSERT INTO MATRICULAS VALUES (7, 'MUS', 410, 'E');
    INSERT INTO MATRICULAS VALUES (7, 'MUS', 410, 'E');
    INSERT INTO MATRICULAS VALUES (33, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (83, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (73, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (53, 'CIV', 129, 'B');
    --
    INSERT INTO MATRICULAS VALUES (18, 'DEP', 100, 'E');
    INSERT INTO MATRICULAS VALUES (34, 'CTS', 102, 'B');
    INSERT INTO MATRICULAS VALUES (124, 'CTS', 102, 'C');
    INSERT INTO MATRICULAS VALUES (161, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (122, 'HIS', 101, 'B');
    INSERT INTO MATRICULAS VALUES (113, 'HIS', 101, 'B');
    INSERT INTO MATRICULAS VALUES (114, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (115, 'HIS', 301, 'C');
    INSERT INTO MATRICULAS VALUES (117, 'PRO', 122, 'C');
    INSERT INTO MATRICULAS VALUES (137, 'DEP', 100, 'E');
    INSERT INTO MATRICULAS VALUES (18, 'HIS', 101, 'B');
    INSERT INTO MATRICULAS VALUES (119, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (110, 'HIS', 101, 'D');
    INSERT INTO MATRICULAS VALUES (111, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (119, 'PRO', 122, 'A');
    INSERT INTO MATRICULAS VALUES (121, 'NUT', 307, 'A');
    INSERT INTO MATRICULAS VALUES (111, 'MUS', 410, 'C');
    INSERT INTO MATRICULAS VALUES (117, 'MUS', 410, 'B');
    INSERT INTO MATRICULAS VALUES (116, 'MUS', 410, 'E');
    INSERT INTO MATRICULAS VALUES (155, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (102, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (101, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (186, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (8, 'DEP', 100, 'E');
    INSERT INTO MATRICULAS VALUES (14, 'DEP', 100, 'B');
    INSERT INTO MATRICULAS VALUES (124, 'CTS', 102, 'C');
    INSERT INTO MATRICULAS VALUES (161, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (122, 'HIS', 101, 'B');
    INSERT INTO MATRICULAS VALUES (113, 'HIS', 101, 'B');
    ...
    INSERT INTO MATRICULAS VALUES (117, 'PRO', 122, 'C');
    INSERT INTO MATRICULAS VALUES (137, 'DEP', 100, 'E');
    INSERT INTO MATRICULAS VALUES (180, 'HIS', 101, 'B');
    INSERT INTO MATRICULAS VALUES (91, 'CTS', 102, 'A');
    INSERT INTO MATRICULAS VALUES (10, 'CTS', 102, 'D');
    INSERT INTO MATRICULAS VALUES (90, 'HIS', 101, 'A');
    INSERT INTO MATRICULAS VALUES (91, 'SOF', 101, 'A');
    INSERT INTO MATRICULAS VALUES (31, 'CVI', 130, 'A');
    INSERT INTO MATRICULAS VALUES (33, 'MUS', 410, 'C');
    INSERT INTO MATRICULAS VALUES (54, 'MUS', 410, 'B');
    INSERT INTO MATRICULAS VALUES (22, 'MUS', 410, 'E');
    INSERT INTO MATRICULAS VALUES (98, 'CIV', 129, 'A');
    INSERT INTO MATRICULAS VALUES (99, 'SOF', 101, 'E');
    INSERT INTO MATRICULAS VALUES (100, 'INT', 301, 'A');
    INSERT INTO MATRICULAS VALUES (185, 'BIO', 555, 'A');
